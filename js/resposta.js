...
function pergunta1(){
    ...
    let resultado = "Parabéns!! Acertou!!!"
    let resultado2 = "Errou!!! Quem sabe na próxima vez!!!"
...
function pergunta3(){
    let alt33 = document.getElementById("alt33").checked
    let resultado = "Parabéns!! Acertou!!!"
    let resultado2 = "Errou!!! Quem sabe na próxima vez!!!"
...
function pergunta5(){
    let alt51 = document.getElementById("alt51").checked
    let resultado = "Parabéns!! Acertou!!!"
    let resultado2 = "Errou!!! Quem sabe na próxima vez!!!"
...
function pergunta6(){
    let alt62 = document.getElementById("alt62").checked
    let resultado = "Parabéns!! Acertou!!!"
    let resultado2 = "Errou!!! Quem sabe na próxima vez!!!"
...
function pergunta7(){
    let alt71 = document.getElementById("alt71").checked
    let resultado = "Parabéns!! Acertou!!!"
    let resultado2 = "Errou!!! Quem sabe na próxima vez!!!"
...
function pergunta11(){
    let alt112 = document.getElementById("alt112").checked
    let resultado = "Parabéns!! Acertou!!!"
    let resultado2 = "Errou!!! Quem sabe na próxima vez!!!"
...
function pergunta12(){
    let alt121 = document.getElementById("alt121").checked
    let resultado = "Parabéns!! Acertou!!!"
    let resultado2 = "Errou!!! Quem sabe na próxima vez!!!"
